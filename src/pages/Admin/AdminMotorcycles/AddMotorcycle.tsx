...
function AddMotorcycle() {
    ...
    const validateForm = (): boolean => {
        ...
        if (!formData.downpayment.trim()) newErrors.downpayment = "Downpayment is required.";
        if (!formData.monthly.trim()) newErrors.monthly = "Monthly Payment is required.";
        if (!formData.description.trim()) newErrors.description = "Description is required.";
        if (!formData.motorcycleImage) newErrors.motorcycleImage = "Main Motorcycle Image is required.";
        if (!formData.specificationTableImage) newErrors.specificationTableImage = "Specification Table Image is required.";
        if (!formData.relatedMotorcycleImage) newErrors.relatedMotorcycleImage = "Related Motorcycle Image is required.";
        ...
        return (
            <div className="relative border-2 border-dashed border-gray-200 rounded-lg p-6 w-full flex flex-col items-center transition-all hover:border-blue-400 hover:bg-blue-50">
                ...
                {errors[fieldName as keyof FormData] && (
                    <p className="text-red-500 text-sm mt-1">{errors[fieldName as keyof FormData]}</p>
                )}
            </div>
        );
    };
                        ...
                        <div className="p-6">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="bg-blue-50 rounded-lg p-5">
                                            ...
                                            <div key={name} className="space-y-1">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`block w-full pl-10 pr-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 ${
                                    ...
                                    <div className="mt-5">
                                        ...
                                        <textarea
                                            ...
                                            className={`mt-1 block w-full border rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 p-3 ${
                                ...
                                <div className="flex justify-end space-x-4 pt-4 border-t border-gray-200">
                                    <button
                                        type="button"
                                        className="px-6 py-2.5 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all"
                                    >
